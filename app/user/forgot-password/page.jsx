          ...
          <div className="w-full max-w-[380px]">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full rounded-lg cursor-pointer bg-[#1ea7d8] py-2.5 text-[12px] font-semibold text-white transition 
                  ${isLoading 
            ...
            <p className="mt-6 text-center text-[12px] text-[#6b7280]">
              ...
              <button
                ...
                className="font-semibold text-[#2563eb] hover:underline disabled:opacity-50 cursor-pointer"
                disabled={isLoading}
              >
                Back now
              </button>
