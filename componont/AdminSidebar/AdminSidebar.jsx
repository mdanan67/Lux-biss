      ...
      >
        <div className="flex h-full flex-col">
          ...
          <nav className="px-4 py-4 space-y-3 overflow-y-auto">
            <NavItem active label="Dashboard" icon={<IconDashboard />} />
            <NavItem label="Statistics" icon={<IconStats />} />
            <NavItem label="Products" icon={<IconList />} />
            <NavItem label="All User" icon={<IconUsers />} />
            <NavItem label="Transactions" icon={<IconMoney />} />
            <NavItem label="Wallet" icon={<IconWallet />} />
            <NavItem label="Gift Cards" icon={<IconGift />} />
            <NavItem label="Managers" icon={<IconUser />} />
            <NavItem label="Ignored Users" icon={<IconSettings />} />
            <NavItem label="Telegram Steup" icon={<IconSend />} />
          </nav>
